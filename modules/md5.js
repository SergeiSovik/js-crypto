...
// Constants table
const T = platform.FixedInt32Array(64);
 ...
 * MD5 hash algorithm.
 */
export class HasherMD5 extends Hasher {
	_doReset() {
...
export function MD5(message) {
	return _MD5.init().finalize(message);
}
 ...
 * @example
 *
 *     let hmac = HmacMD5(message, key);
 */
export function HmacMD5(message, key) {
	return new HMAC(_MD5, key).finalize(message);
}
