...
// Reusable object
let W = platform.FixedInt32Array(80);
 ...
 *     let hash = SHA1(wordArray);
 */
export function SHA1(message) {
	return _SHA1.init().finalize(message);
}
 ...
 * @example
 *
 *     let hmac = HmacSHA1(message, key);
 */
export function HmacSHA1(message, key) {
	return new HMAC(_SHA1, key).finalize(message);
}
